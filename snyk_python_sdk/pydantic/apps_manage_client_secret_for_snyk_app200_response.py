...
from snyk_python_sdk.pydantic.app_install_data_with_secret import AppInstallDataWithSecret
from snyk_python_sdk.pydantic.json_api import JsonApi
from snyk_python_sdk.pydantic.self_link import SelfLink

class AppsManageClientSecretForSnykApp200Response(BaseModel):
    data: typing.Optional[AppInstallDataWithSecret] = Field(None, alias='data')
