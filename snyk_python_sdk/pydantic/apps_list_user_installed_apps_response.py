...
from snyk_python_sdk.pydantic.app_install_data import AppInstallData
from snyk_python_sdk.pydantic.json_api import JsonApi
from snyk_python_sdk.pydantic.paginated_links import PaginatedLinks

class AppsListUserInstalledAppsResponse(BaseModel):
    data: typing.List[AppInstallData] = Field(alias='data')
