...
from snyk_python_sdk.pydantic.sast_enablement import SastEnablement

class SastSettingsToggleSnykCodeSettingsResponse(BaseModel):
    data: SastEnablement = Field(alias='data')
