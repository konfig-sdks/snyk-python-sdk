...
from snyk_python_sdk.pydantic.org_with_relationships import OrgWithRelationships
from snyk_python_sdk.pydantic.paginated_links import PaginatedLinks

class OrgsListAccessibleOrganizationsResponse(BaseModel):
    data: typing.List[OrgWithRelationships] = Field(alias='data')
