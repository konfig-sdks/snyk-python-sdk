...
class RequiredServiceAccountsListGroupServiceAccountsResponseDataItemAttributes(TypedDict):
...
class OptionalServiceAccountsListGroupServiceAccountsResponseDataItemAttributes(TypedDict, total=False):
...
class ServiceAccountsListGroupServiceAccountsResponseDataItemAttributes(RequiredServiceAccountsListGroupServiceAccountsResponseDataItemAttributes, OptionalServiceAccountsListGroupServiceAccountsResponseDataItemAttributes):
    pass
