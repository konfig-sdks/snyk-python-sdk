...
class RequiredServiceAccountsUpdateOrganizationServiceAccountNameResponseDataAttributes(TypedDict):
...
class OptionalServiceAccountsUpdateOrganizationServiceAccountNameResponseDataAttributes(TypedDict, total=False):
...
class ServiceAccountsUpdateOrganizationServiceAccountNameResponseDataAttributes(RequiredServiceAccountsUpdateOrganizationServiceAccountNameResponseDataAttributes, OptionalServiceAccountsUpdateOrganizationServiceAccountNameResponseDataAttributes):
    pass
