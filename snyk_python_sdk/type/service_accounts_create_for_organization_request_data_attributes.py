...
class RequiredServiceAccountsCreateForOrganizationRequestDataAttributes(TypedDict):
...
class OptionalServiceAccountsCreateForOrganizationRequestDataAttributes(TypedDict, total=False):
...
class ServiceAccountsCreateForOrganizationRequestDataAttributes(RequiredServiceAccountsCreateForOrganizationRequestDataAttributes, OptionalServiceAccountsCreateForOrganizationRequestDataAttributes):
    pass
