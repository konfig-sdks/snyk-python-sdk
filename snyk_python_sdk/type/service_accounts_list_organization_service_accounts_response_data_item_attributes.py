...
class RequiredServiceAccountsListOrganizationServiceAccountsResponseDataItemAttributes(TypedDict):
...
class OptionalServiceAccountsListOrganizationServiceAccountsResponseDataItemAttributes(TypedDict, total=False):
...
class ServiceAccountsListOrganizationServiceAccountsResponseDataItemAttributes(RequiredServiceAccountsListOrganizationServiceAccountsResponseDataItemAttributes, OptionalServiceAccountsListOrganizationServiceAccountsResponseDataItemAttributes):
    pass
