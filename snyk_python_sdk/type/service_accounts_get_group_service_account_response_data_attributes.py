...
class RequiredServiceAccountsGetGroupServiceAccountResponseDataAttributes(TypedDict):
...
class OptionalServiceAccountsGetGroupServiceAccountResponseDataAttributes(TypedDict, total=False):
...
class ServiceAccountsGetGroupServiceAccountResponseDataAttributes(RequiredServiceAccountsGetGroupServiceAccountResponseDataAttributes, OptionalServiceAccountsGetGroupServiceAccountResponseDataAttributes):
    pass
