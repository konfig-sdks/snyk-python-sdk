...
class RequiredServiceAccountsManageClientSecretResponseDataAttributes(TypedDict):
...
class OptionalServiceAccountsManageClientSecretResponseDataAttributes(TypedDict, total=False):
...
class ServiceAccountsManageClientSecretResponseDataAttributes(RequiredServiceAccountsManageClientSecretResponseDataAttributes, OptionalServiceAccountsManageClientSecretResponseDataAttributes):
    pass
