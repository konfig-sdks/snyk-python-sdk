...
class RequiredServiceAccountsCreateGroupResponseDataAttributes(TypedDict):
...
class OptionalServiceAccountsCreateGroupResponseDataAttributes(TypedDict, total=False):
...
class ServiceAccountsCreateGroupResponseDataAttributes(RequiredServiceAccountsCreateGroupResponseDataAttributes, OptionalServiceAccountsCreateGroupResponseDataAttributes):
    pass
