...
RequiredServiceAccountLinks = TypedDict("RequiredServiceAccountLinks", {
    })

OptionalServiceAccountLinks = TypedDict("OptionalServiceAccountLinks", {
...
class ServiceAccountLinks(RequiredServiceAccountLinks, OptionalServiceAccountLinks):
    pass
