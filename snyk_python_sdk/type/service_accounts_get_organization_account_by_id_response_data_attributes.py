...
class RequiredServiceAccountsGetOrganizationAccountByIdResponseDataAttributes(TypedDict):
...
class OptionalServiceAccountsGetOrganizationAccountByIdResponseDataAttributes(TypedDict, total=False):
...
class ServiceAccountsGetOrganizationAccountByIdResponseDataAttributes(RequiredServiceAccountsGetOrganizationAccountByIdResponseDataAttributes, OptionalServiceAccountsGetOrganizationAccountByIdResponseDataAttributes):
    pass
