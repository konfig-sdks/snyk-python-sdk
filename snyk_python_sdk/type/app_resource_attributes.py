...
class RequiredAppResourceAttributes(TypedDict):
...
class OptionalAppResourceAttributes(TypedDict, total=False):
...
class AppResourceAttributes(RequiredAppResourceAttributes, OptionalAppResourceAttributes):
    pass
