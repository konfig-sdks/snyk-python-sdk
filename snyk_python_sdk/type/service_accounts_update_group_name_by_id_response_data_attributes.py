...
class RequiredServiceAccountsUpdateGroupNameByIdResponseDataAttributes(TypedDict):
...
class OptionalServiceAccountsUpdateGroupNameByIdResponseDataAttributes(TypedDict, total=False):
...
class ServiceAccountsUpdateGroupNameByIdResponseDataAttributes(RequiredServiceAccountsUpdateGroupNameByIdResponseDataAttributes, OptionalServiceAccountsUpdateGroupNameByIdResponseDataAttributes):
    pass
