...
class RequiredServiceAccountsManageClientSecretForOrganizationServiceAccountResponseDataAttributes(TypedDict):
...
class OptionalServiceAccountsManageClientSecretForOrganizationServiceAccountResponseDataAttributes(TypedDict, total=False):
...
class ServiceAccountsManageClientSecretForOrganizationServiceAccountResponseDataAttributes(RequiredServiceAccountsManageClientSecretForOrganizationServiceAccountResponseDataAttributes, OptionalServiceAccountsManageClientSecretForOrganizationServiceAccountResponseDataAttributes):
    pass
