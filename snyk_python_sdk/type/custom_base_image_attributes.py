...
class RequiredCustomBaseImageAttributes(TypedDict):
...
class OptionalCustomBaseImageAttributes(TypedDict, total=False):
    versioning_schema: VersioningSchema

class CustomBaseImageAttributes(RequiredCustomBaseImageAttributes, OptionalCustomBaseImageAttributes):
    pass
