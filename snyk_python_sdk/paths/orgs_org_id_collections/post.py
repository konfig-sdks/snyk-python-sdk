...
from snyk_python_sdk.model.collection_create_new_response import CollectionCreateNewResponse as CollectionCreateNewResponseSchema
...
from snyk_python_sdk.model.create_collection_request import CreateCollectionRequest as CreateCollectionRequestSchema
from snyk_python_sdk.model.create_collection_request_data import CreateCollectionRequestData as CreateCollectionRequestDataSchema

from snyk_python_sdk.type.collection_create_new_response import CollectionCreateNewResponse
...
from snyk_python_sdk.type.create_collection_request import CreateCollectionRequest

from ...api_client import Dictionary
from snyk_python_sdk.pydantic.collection_create_new_response import CollectionCreateNewResponse as CollectionCreateNewResponsePydantic
from snyk_python_sdk.pydantic.actual_version import ActualVersion as ActualVersionPydantic
from snyk_python_sdk.pydantic.create_collection_request_data import CreateCollectionRequestData as CreateCollectionRequestDataPydantic
from snyk_python_sdk.pydantic.create_collection_request import CreateCollectionRequest as CreateCollectionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationVndApijson = CreateCollectionRequestSchema


request_body_create_collection_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndApijson = CollectionCreateNewResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: CollectionCreateNewResponse
    ...
    async def _acreate_new_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orgs/{org_id}/collections',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_create_collection_request.serialize(body, content_type)
...
class CreateNew(BaseApi):
    ...
    async def acreate_new(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CollectionCreateNewResponsePydantic:
        ...
        if validate:
            return CollectionCreateNewResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CollectionCreateNewResponsePydantic, raw_response.body)
