...
from snyk_python_sdk.model.iac_settings_get_for_group_response import IacSettingsGetForGroupResponse as IacSettingsGetForGroupResponseSchema
from snyk_python_sdk.model.query_version import QueryVersion as QueryVersionSchema

from snyk_python_sdk.type.iac_settings_get_for_group_response import IacSettingsGetForGroupResponse
...
from snyk_python_sdk.pydantic.iac_settings_get_for_group_response import IacSettingsGetForGroupResponse as IacSettingsGetForGroupResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndApijson = IacSettingsGetForGroupResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: IacSettingsGetForGroupResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_for_group_mapped_args(
        self,
    ...
    async def _aget_for_group_oapg(
        self,
...
class GetForGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_for_group(
        self,
        version: QueryVersion,
        group_id: str,
        **kwargs,
        ...
        args = self._get_for_group_mapped_args(
            version=version,
            group_id=group_id,
        )
        return await self._aget_for_group_oapg(
    ...
    def get_for_group(
        ...
        return self._get_for_group_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetForGroup(BaseApi):
    ...
    async def aget_for_group(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IacSettingsGetForGroupResponsePydantic:
        raw_response = await self.raw.aget_for_group(
            version=version,
            group_id=group_id,
            **kwargs,
        )
        if validate:
            return IacSettingsGetForGroupResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(IacSettingsGetForGroupResponsePydantic, raw_response.body)
    ...
    def get_for_group(
        ...
        raw_response = self.raw.get_for_group(
            version=version,
            group_id=group_id,
        )
        if validate:
