...
from snyk_python_sdk.model.sast_settings_get_for_org_response import SastSettingsGetForOrgResponse as SastSettingsGetForOrgResponseSchema
...
from snyk_python_sdk.type.sast_settings_get_for_org_response import SastSettingsGetForOrgResponse
...
from snyk_python_sdk.pydantic.sast_settings_get_for_org_response import SastSettingsGetForOrgResponse as SastSettingsGetForOrgResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndApijson = SastSettingsGetForOrgResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: SastSettingsGetForOrgResponse
...
class GetForOrgRaw(BaseApi):
    ...
    async def aget_for_org(
        ...
        **kwargs,
        ...
        args = self._get_for_org_mapped_args(
            version=version,
            org_id=org_id,
        )
        return await self._aget_for_org_oapg(
    ...
    def get_for_org(
        ...
        return self._get_for_org_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetForOrg(BaseApi):
    ...
    async def aget_for_org(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SastSettingsGetForOrgResponsePydantic:
        raw_response = await self.raw.aget_for_org(
            version=version,
            org_id=org_id,
            **kwargs,
        )
        if validate:
            return SastSettingsGetForOrgResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SastSettingsGetForOrgResponsePydantic, raw_response.body)
    ...
    def get_for_org(
        ...
        raw_response = self.raw.get_for_org(
            version=version,
            org_id=org_id,
        )
        if validate:
