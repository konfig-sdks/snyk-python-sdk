...
from snyk_python_sdk.model.orgs_get_details_response import OrgsGetDetailsResponse as OrgsGetDetailsResponseSchema
...
from snyk_python_sdk.type.orgs_get_details_response import OrgsGetDetailsResponse
...
from snyk_python_sdk.pydantic.orgs_get_details_response import OrgsGetDetailsResponse as OrgsGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndApijson = OrgsGetDetailsResponseSchema
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrgsGetDetailsResponsePydantic:
        ...
        if validate:
            return OrgsGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OrgsGetDetailsResponsePydantic, raw_response.body)
