...
from snyk_python_sdk.model.slack_get_channel_name_by_id_response import SlackGetChannelNameByIdResponse as SlackGetChannelNameByIdResponseSchema

from snyk_python_sdk.type.slack_get_channel_name_by_id_response import SlackGetChannelNameByIdResponse
...
from snyk_python_sdk.pydantic.slack_get_channel_name_by_id_response import SlackGetChannelNameByIdResponse as SlackGetChannelNameByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndApijson = SlackGetChannelNameByIdResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: SlackGetChannelNameByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_channel_name_by_id_mapped_args(
        self,
    ...
    async def _aget_channel_name_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orgs/{org_id}/slack_app/{tenant_id}/channels/{channel_id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_channel_name_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetChannelNameByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_channel_name_by_id(
        self,
        version: QueryVersion,
        org_id: str,
        channel_id: str,
        ...
        **kwargs,
        ...
        args = self._get_channel_name_by_id_mapped_args(
            version=version,
            org_id=org_id,
            channel_id=channel_id,
            tenant_id=tenant_id,
        )
        return await self._aget_channel_name_by_id_oapg(
    ...
    def get_channel_name_by_id(
        ...
        return self._get_channel_name_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetChannelNameById(BaseApi):
    ...
    async def aget_channel_name_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SlackGetChannelNameByIdResponsePydantic:
        raw_response = await self.raw.aget_channel_name_by_id(
            version=version,
            org_id=org_id,
            channel_id=channel_id,
            tenant_id=tenant_id,
        ...
        if validate:
            return SlackGetChannelNameByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SlackGetChannelNameByIdResponsePydantic, raw_response.body)
    ...
    def get_channel_name_by_id(
        ...
        raw_response = self.raw.get_channel_name_by_id(
            version=version,
            org_id=org_id,
            channel_id=channel_id,
            tenant_id=tenant_id,
