...
from snyk_python_sdk.model.targets_get_by_id_response import TargetsGetByIdResponse as TargetsGetByIdResponseSchema

from snyk_python_sdk.type.targets_get_by_id_response import TargetsGetByIdResponse
...
from snyk_python_sdk.pydantic.targets_get_by_id_response import TargetsGetByIdResponse as TargetsGetByIdResponsePydantic
...
TargetIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'org_id': typing.Union[OrgIdSchema, str, uuid.UUID, ],
        'target_id': typing.Union[TargetIdSchema, str, uuid.UUID, ],
    }
)
...
SchemaFor200ResponseBodyApplicationVndApijson = TargetsGetByIdResponseSchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orgs/{org_id}/targets/{target_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TargetsGetByIdResponsePydantic:
        ...
        if validate:
            return TargetsGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TargetsGetByIdResponsePydantic, raw_response.body)
