...
from snyk_python_sdk.model.orgs_list_accessible_organizations_response import OrgsListAccessibleOrganizationsResponse as OrgsListAccessibleOrganizationsResponseSchema

from snyk_python_sdk.type.orgs_list_accessible_organizations_response import OrgsListAccessibleOrganizationsResponse
...
from snyk_python_sdk.pydantic.orgs_list_accessible_organizations_response import OrgsListAccessibleOrganizationsResponse as OrgsListAccessibleOrganizationsResponsePydantic
...
IsPersonalSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'is_personal': typing.Union[IsPersonalSchema, bool, ],
...
request_query_is_personal = api_client.QueryParameter(
    name="is_personal",
    style=api_client.ParameterStyle.FORM,
    schema=IsPersonalSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationVndApijson = OrgsListAccessibleOrganizationsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: OrgsListAccessibleOrganizationsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_accessible_organizations_mapped_args(
        self,
        ...
        if is_personal is not None:
            _query_params["is_personal"] = is_personal
        if slug is not None:
    ...
    async def _alist_accessible_organizations_oapg(
        self,
    ...
    def _list_accessible_organizations_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListAccessibleOrganizationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_accessible_organizations(
        self,
        version: QueryVersion,
        starting_after: typing.Optional[str] = None,
        ending_before: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_accessible_organizations_mapped_args(
            version=version,
        ...
        return await self._alist_accessible_organizations_oapg(
    ...
    def list_accessible_organizations(
        ...
        return self._list_accessible_organizations_oapg(
            query_params=args.query,
        )

class ListAccessibleOrganizations(BaseApi):
    ...
    async def alist_accessible_organizations(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrgsListAccessibleOrganizationsResponsePydantic:
        raw_response = await self.raw.alist_accessible_organizations(
            version=version,
            starting_after=starting_after,
            ending_before=ending_before,
            limit=limit,
        ...
        if validate:
            return OrgsListAccessibleOrganizationsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OrgsListAccessibleOrganizationsResponsePydantic, raw_response.body)
    ...
    def list_accessible_organizations(
        ...
        raw_response = self.raw.list_accessible_organizations(
            version=version,
            starting_after=starting_after,
            ending_before=ending_before,
            limit=limit,
