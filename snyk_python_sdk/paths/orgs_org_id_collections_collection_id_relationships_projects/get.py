...
from snyk_python_sdk.model.get_projects_of_collection_response import GetProjectsOfCollectionResponse as GetProjectsOfCollectionResponseSchema
...
from snyk_python_sdk.type.get_projects_of_collection_response import GetProjectsOfCollectionResponse
...
from snyk_python_sdk.pydantic.get_projects_of_collection_response import GetProjectsOfCollectionResponse as GetProjectsOfCollectionResponsePydantic
...
class SortSchema(
    ...
    @schemas.classproperty
    def LAST_TESTED_AT(cls):
        return cls("last_tested_at")
...
class ShowSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    "vuln-groups": "VULNGROUPS",
                    "clean-groups": "CLEANGROUPS",
                }
            
            @schemas.classproperty
            def VULNGROUPS(cls):
                return cls("vuln-groups")
            
            @schemas.classproperty
            def CLEANGROUPS(cls):
                return cls("clean-groups")
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'show': typing.Union[ShowSchema, list, tuple, ],
        'integration': typing.Union[IntegrationSchema, list, tuple, ],
    },
    total=False
)
...
request_query_show = api_client.QueryParameter(
    name="show",
    style=api_client.ParameterStyle.FORM,
    schema=ShowSchema,
    explode=True,
...
CollectionIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'org_id': typing.Union[OrgIdSchema, str, uuid.UUID, ],
        'collection_id': typing.Union[CollectionIdSchema, str, uuid.UUID, ],
    }
)
...
SchemaFor200ResponseBodyApplicationVndApijson = GetProjectsOfCollectionResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetProjectsOfCollectionResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_projects_mapped_args(
        ...
        show: typing.Optional[typing.List[str]] = None,
        integration: typing.Optional[typing.List[str]] = None,
    ...
    async def _aget_projects_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orgs/{org_id}/collections/{collection_id}/relationships/projects',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetProjectsRaw(BaseApi):
    ...
    async def aget_projects(
        ...
        **kwargs,
        ...
        args = self._get_projects_mapped_args(
            version=version,
            org_id=org_id,
        ...
        return await self._aget_projects_oapg(
...
class GetProjects(BaseApi):
    ...
    async def aget_projects(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetProjectsOfCollectionResponsePydantic:
        raw_response = await self.raw.aget_projects(
            version=version,
            org_id=org_id,
            collection_id=collection_id,
            starting_after=starting_after,
        ...
        if validate:
            return GetProjectsOfCollectionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetProjectsOfCollectionResponsePydantic, raw_response.body)
    ...
    def get_projects(
        ...
        raw_response = self.raw.get_projects(
            version=version,
            org_id=org_id,
            collection_id=collection_id,
            starting_after=starting_after,
