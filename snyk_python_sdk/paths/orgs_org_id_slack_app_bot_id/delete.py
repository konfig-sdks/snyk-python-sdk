...
class BaseApi(api_client.Api):
    ...
    def _remove_integration_mapped_args(
        self,
    ...
    async def _aremove_integration_oapg(
        self,
...
class RemoveIntegrationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_integration(
        self,
        version: QueryVersion,
        org_id: str,
        bot_id: str,
        **kwargs,
        ...
        args = self._remove_integration_mapped_args(
            version=version,
            org_id=org_id,
            bot_id=bot_id,
        )
        return await self._aremove_integration_oapg(
    ...
    def remove_integration(
        ...
        return self._remove_integration_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class RemoveIntegration(BaseApi):
    ...
    async def aremove_integration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_integration(
            version=version,
            org_id=org_id,
            bot_id=bot_id,
            **kwargs,
    ...
    def remove_integration(
        ...
        raw_response = self.raw.remove_integration(
            version=version,
            org_id=org_id,
            bot_id=bot_id,
        )
