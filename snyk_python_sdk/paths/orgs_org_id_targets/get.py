...
from snyk_python_sdk.model.targets_list_by_org_id_response import TargetsListByOrgIdResponse as TargetsListByOrgIdResponseSchema
...
from snyk_python_sdk.type.targets_list_by_org_id_response import TargetsListByOrgIdResponse
...
from snyk_python_sdk.pydantic.targets_list_by_org_id_response import TargetsListByOrgIdResponse as TargetsListByOrgIdResponsePydantic
...
ExcludeEmptySchema = schemas.BoolSchema
UrlSchema = schemas.StrSchema


class SourceTypesSchema(
    schemas.ListSchema
):
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "bitbucket-connect-app": "BITBUCKETCONNECTAPP",
                    "azure-repos": "AZUREREPOS",
                    "github": "GITHUB",
                    "github-cloud-app": "GITHUBCLOUDAPP",
                    "github-server-app": "GITHUBSERVERAPP",
                    "cli": "CLI",
                    "docker-hub": "DOCKERHUB",
                    "in-memory-fs": "INMEMORYFS",
                    "acr": "ACR",
                    "ecr": "ECR",
                    "gcr": "GCR",
                    "artifactory-cr": "ARTIFACTORYCR",
                    "harbor-cr": "HARBORCR",
                    "quay-cr": "QUAYCR",
                    "github-cr": "GITHUBCR",
                    "nexus-cr": "NEXUSCR",
                    "nexus-private-repo": "NEXUSPRIVATEREPO",
                    "digitalocean-cr": "DIGITALOCEANCR",
                    "gitlab-cr": "GITLABCR",
                    "google-artifact-cr": "GOOGLEARTIFACTCR",
                    "heroku": "HEROKU",
            ...
            @schemas.classproperty
            def GITHUBENTERPRISE(cls):
                return cls("github-enterprise")
            
            @schemas.classproperty
            def BITBUCKETCLOUD(cls):
                return cls("bitbucket-cloud")
            
            @schemas.classproperty
            def BITBUCKETCONNECTAPP(cls):
                return cls("bitbucket-connect-app")
            
            @schemas.classproperty
            def AZUREREPOS(cls):
                return cls("azure-repos")
            ...
            @schemas.classproperty
            def GITHUBCLOUDAPP(cls):
                return cls("github-cloud-app")
            
            @schemas.classproperty
            def GITHUBSERVERAPP(cls):
                return cls("github-server-app")
            ...
            @schemas.classproperty
            def DOCKERHUB(cls):
                return cls("docker-hub")
            
            @schemas.classproperty
            def INMEMORYFS(cls):
                return cls("in-memory-fs")
            ...
            @schemas.classproperty
            def ARTIFACTORYCR(cls):
                return cls("artifactory-cr")
            
            @schemas.classproperty
            def HARBORCR(cls):
                return cls("harbor-cr")
            ...
            @schemas.classproperty
            def NEXUSPRIVATEREPO(cls):
                return cls("nexus-private-repo")
            
            @schemas.classproperty
            def DIGITALOCEANCR(cls):
                return cls("digitalocean-cr")
            
            @schemas.classproperty
            def GITLABCR(cls):
                return cls("gitlab-cr")
            
            @schemas.classproperty
            def GOOGLEARTIFACTCR(cls):
                return cls("google-artifact-cr")
            ...
            @schemas.classproperty
            def AZUREFUNCTIONS(cls):
                return cls("azure-functions")
            
            @schemas.classproperty
            def CLOUDFOUNDRY(cls):
                return cls("cloud-foundry")
            ...
            @schemas.classproperty
            def IBMCLOUD(cls):
                return cls("ibm-cloud")
            
            @schemas.classproperty
            def TERRAFORMCLOUD(cls):
                return cls("terraform-cloud")
...
CreatedGteSchema = schemas.DateTimeSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'exclude_empty': typing.Union[ExcludeEmptySchema, bool, ],
        'url': typing.Union[UrlSchema, str, ],
        'source_types': typing.Union[SourceTypesSchema, list, tuple, ],
        'display_name': typing.Union[DisplayNameSchema, str, ],
        'created_gte': typing.Union[CreatedGteSchema, str, datetime, ],
    },
    total=False
)
...
request_query_exclude_empty = api_client.QueryParameter(
    name="exclude_empty",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludeEmptySchema,
    explode=True,
)
...
request_query_source_types = api_client.QueryParameter(
    name="source_types",
    style=api_client.ParameterStyle.FORM,
    schema=SourceTypesSchema,
)
...
request_query_created_gte = api_client.QueryParameter(
    name="created_gte",
    style=api_client.ParameterStyle.FORM,
    schema=CreatedGteSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationVndApijson = TargetsListByOrgIdResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: TargetsListByOrgIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_by_org_id_mapped_args(
        ...
        created_gte: typing.Optional[datetime] = None,
        ...
        if is_private is not None:
            _query_params["is_private"] = is_private
        if exclude_empty is not None:
            _query_params["exclude_empty"] = exclude_empty
        if url is not None:
            _query_params["url"] = url
        if source_types is not None:
            _query_params["source_types"] = source_types
        if display_name is not None:
            _query_params["display_name"] = display_name
        if created_gte is not None:
            _query_params["created_gte"] = created_gte
    ...
    async def _alist_by_org_id_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_exclude_empty,
            request_query_url,
            request_query_source_types,
            request_query_display_name,
            request_query_created_gte,
        ):
        ...
        request_before_hook(
            ...
            path_template='/orgs/{org_id}/targets',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByOrgId(BaseApi):
    ...
    async def alist_by_org_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TargetsListByOrgIdResponsePydantic:
        ...
        if validate:
            return TargetsListByOrgIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TargetsListByOrgIdResponsePydantic, raw_response.body)
