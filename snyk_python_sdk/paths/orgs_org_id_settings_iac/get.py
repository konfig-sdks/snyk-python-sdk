...
from snyk_python_sdk.model.iac_settings_get_for_org_iac_response import IacSettingsGetForOrgIacResponse as IacSettingsGetForOrgIacResponseSchema

from snyk_python_sdk.type.iac_settings_get_for_org_iac_response import IacSettingsGetForOrgIacResponse
...
from snyk_python_sdk.pydantic.iac_settings_get_for_org_iac_response import IacSettingsGetForOrgIacResponse as IacSettingsGetForOrgIacResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndApijson = IacSettingsGetForOrgIacResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: IacSettingsGetForOrgIacResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_for_org_iac_mapped_args(
        self,
    ...
    async def _aget_for_org_iac_oapg(
        self,
...
class GetForOrgIacRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_for_org_iac(
        self,
        version: QueryVersion,
        org_id: str,
        **kwargs,
        ...
        args = self._get_for_org_iac_mapped_args(
            version=version,
            org_id=org_id,
        )
        return await self._aget_for_org_iac_oapg(
    ...
    def get_for_org_iac(
        ...
        return self._get_for_org_iac_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetForOrgIac(BaseApi):
    ...
    async def aget_for_org_iac(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IacSettingsGetForOrgIacResponsePydantic:
        raw_response = await self.raw.aget_for_org_iac(
            version=version,
            org_id=org_id,
            **kwargs,
        )
        if validate:
            return IacSettingsGetForOrgIacResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(IacSettingsGetForOrgIacResponsePydantic, raw_response.body)
    ...
    def get_for_org_iac(
        ...
        raw_response = self.raw.get_for_org_iac(
            version=version,
            org_id=org_id,
        )
        if validate:
