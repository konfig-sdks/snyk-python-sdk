...
from snyk_python_sdk.model.slack_get_channels_response import SlackGetChannelsResponse as SlackGetChannelsResponseSchema
...
from snyk_python_sdk.type.slack_get_channels_response import SlackGetChannelsResponse
...
from snyk_python_sdk.pydantic.slack_get_channels_response import SlackGetChannelsResponse as SlackGetChannelsResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndApijson = SlackGetChannelsResponseSchema
    ...
    async def _aget_channels_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orgs/{org_id}/slack_app/{tenant_id}/channels',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetChannelsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_channels(
        self,
        version: QueryVersion,
        org_id: str,
        tenant_id: str,
        ...
        **kwargs,
        ...
        args = self._get_channels_mapped_args(
            version=version,
            org_id=org_id,
            tenant_id=tenant_id,
        ...
        return await self._aget_channels_oapg(
    ...
    def get_channels(
        ...
        return self._get_channels_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetChannels(BaseApi):
    ...
    async def aget_channels(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SlackGetChannelsResponsePydantic:
        raw_response = await self.raw.aget_channels(
            version=version,
            org_id=org_id,
            tenant_id=tenant_id,
            starting_after=starting_after,
        ...
        if validate:
            return SlackGetChannelsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SlackGetChannelsResponsePydantic, raw_response.body)
    ...
    def get_channels(
        ...
        raw_response = self.raw.get_channels(
            version=version,
            org_id=org_id,
            tenant_id=tenant_id,
            starting_after=starting_after,
