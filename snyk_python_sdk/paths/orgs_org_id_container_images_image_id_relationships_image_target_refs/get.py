...
from snyk_python_sdk.model.container_image_list_image_target_refs_response import ContainerImageListImageTargetRefsResponse as ContainerImageListImageTargetRefsResponseSchema
from snyk_python_sdk.model.query_version import QueryVersion as QueryVersionSchema

from snyk_python_sdk.type.container_image_list_image_target_refs_response import ContainerImageListImageTargetRefsResponse
...
from snyk_python_sdk.pydantic.container_image_list_image_target_refs_response import ContainerImageListImageTargetRefsResponse as ContainerImageListImageTargetRefsResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndApijson = ContainerImageListImageTargetRefsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ContainerImageListImageTargetRefsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_image_target_refs_mapped_args(
        self,
        org_id: str,
        image_id: str,
    ...
    async def _alist_image_target_refs_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orgs/{org_id}/container_images/{image_id}/relationships/image_target_refs',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_image_target_refs_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListImageTargetRefsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_image_target_refs(
        self,
        org_id: str,
        image_id: str,
        version: QueryVersion,
        ...
        **kwargs,
        ...
        args = self._list_image_target_refs_mapped_args(
            org_id=org_id,
            image_id=image_id,
            version=version,
            limit=limit,
        ...
        return await self._alist_image_target_refs_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_image_target_refs(
        self,
        org_id: str,
        image_id: str,
        version: QueryVersion,
        ...
        return self._list_image_target_refs_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListImageTargetRefs(BaseApi):
    ...
    async def alist_image_target_refs(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContainerImageListImageTargetRefsResponsePydantic:
        raw_response = await self.raw.alist_image_target_refs(
            org_id=org_id,
            image_id=image_id,
            version=version,
            limit=limit,
        ...
        if validate:
            return ContainerImageListImageTargetRefsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ContainerImageListImageTargetRefsResponsePydantic, raw_response.body)
    ...
    def list_image_target_refs(
        ...
        raw_response = self.raw.list_image_target_refs(
            org_id=org_id,
            image_id=image_id,
            version=version,
            limit=limit,
