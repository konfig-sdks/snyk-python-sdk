...
from snyk_python_sdk.model.get_project_settings_collection import GetProjectSettingsCollection as GetProjectSettingsCollectionSchema

from snyk_python_sdk.type.get_project_settings_collection import GetProjectSettingsCollection
...
from snyk_python_sdk.pydantic.get_project_settings_collection import GetProjectSettingsCollection as GetProjectSettingsCollectionPydantic
...
SchemaFor200ResponseBodyApplicationVndApijson = GetProjectSettingsCollectionSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetProjectSettingsCollection
...
class BaseApi(api_client.Api):
    ...
    def _get_overrides_for_projects_mapped_args(
        self,
    ...
    async def _aget_overrides_for_projects_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orgs/{org_id}/slack_app/{bot_id}/projects',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_overrides_for_projects_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetOverridesForProjectsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_overrides_for_projects(
        self,
        version: QueryVersion,
        org_id: str,
        bot_id: str,
        ...
        **kwargs,
        ...
        args = self._get_overrides_for_projects_mapped_args(
            version=version,
            org_id=org_id,
            bot_id=bot_id,
        ...
        return await self._aget_overrides_for_projects_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_overrides_for_projects(
        self,
        version: QueryVersion,
        org_id: str,
        bot_id: str,
        ...
        return self._get_overrides_for_projects_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOverridesForProjects(BaseApi):
    ...
    async def aget_overrides_for_projects(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetProjectSettingsCollectionPydantic:
        raw_response = await self.raw.aget_overrides_for_projects(
            version=version,
            org_id=org_id,
            bot_id=bot_id,
            starting_after=starting_after,
        ...
        if validate:
            return GetProjectSettingsCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(GetProjectSettingsCollectionPydantic, raw_response.body)
    ...
    def get_overrides_for_projects(
        ...
        raw_response = self.raw.get_overrides_for_projects(
            version=version,
            org_id=org_id,
            bot_id=bot_id,
            starting_after=starting_after,
