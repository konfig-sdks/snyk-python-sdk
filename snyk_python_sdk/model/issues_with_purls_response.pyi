...
class IssuesWithPurlsResponse(
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CommonIssueModelVTwo']:
                        return CommonIssueModelVTwo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CommonIssueModelVTwo'], typing.List['CommonIssueModelVTwo']],
                ...
                def __getitem__(self, i: int) -> 'CommonIssueModelVTwo':
            ...
            @staticmethod
            def meta() -> typing.Type['IssuesWithPurlsResponseMeta']:
                return IssuesWithPurlsResponseMeta
            __annotations__ = {
                "data": data,
                "jsonapi": jsonapi,
                "links": links,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'IssuesWithPurlsResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['IssuesWithPurlsResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        meta: typing.Union['IssuesWithPurlsResponseMeta', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
