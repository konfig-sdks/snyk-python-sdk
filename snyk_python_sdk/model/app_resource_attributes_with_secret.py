...
class AppResourceAttributesWithSecret(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_token_ttl_seconds", "client_id", "client_secret", "context", "grant_type", "is_confidential", "is_public", "name", "redirect_uris", "scopes", "org_public_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_token_ttl_seconds", "client_id", "client_secret", "context", "grant_type", "is_confidential", "is_public", "name", "redirect_uris", "scopes", "org_public_id", ], str]):
