...
class AppsInstallSnykAppToOrgResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['AppInstallWithClient']:
                return AppInstallWithClient
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'AppInstallWithClient': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'AppInstallWithClient': ...
