...
class ServiceAccountsGetOrganizationAccountByIdResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ServiceAccountsGetOrganizationAccountByIdResponseData']:
                return ServiceAccountsGetOrganizationAccountByIdResponseData
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ServiceAccountsGetOrganizationAccountByIdResponseData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'ServiceAccountsGetOrganizationAccountByIdResponseData': ...
