...
class AppsListUserInstalledAppsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AppInstallData']:
                        return AppInstallData
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AppInstallData'], typing.List['AppInstallData']],
                ...
                def __getitem__(self, i: int) -> 'AppInstallData':
