...
class ProjectsGetByProjectIdResponseDataRelationships(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def organization() -> typing.Type['ProjectsGetByProjectIdResponseDataRelationshipsOrganization']:
                return ProjectsGetByProjectIdResponseDataRelationshipsOrganization
            ...
            @staticmethod
            def importer() -> typing.Type['ProjectsGetByProjectIdResponseDataRelationshipsImporter']:
                return ProjectsGetByProjectIdResponseDataRelationshipsImporter
        
            @staticmethod
            def owner() -> typing.Type['ProjectsGetByProjectIdResponseDataRelationshipsOwner']:
                return ProjectsGetByProjectIdResponseDataRelationshipsOwner
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["organization"]) -> 'ProjectsGetByProjectIdResponseDataRelationshipsOrganization': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["target"]) -> MetaOapg.properties.target: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["importer"]) -> 'ProjectsGetByProjectIdResponseDataRelationshipsImporter': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["owner"]) -> 'ProjectsGetByProjectIdResponseDataRelationshipsOwner': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["organization"]) -> 'ProjectsGetByProjectIdResponseDataRelationshipsOrganization': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["target"]) -> MetaOapg.properties.target: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["importer"]) -> typing.Union['ProjectsGetByProjectIdResponseDataRelationshipsImporter', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["owner"]) -> typing.Union['ProjectsGetByProjectIdResponseDataRelationshipsOwner', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        importer: typing.Union['ProjectsGetByProjectIdResponseDataRelationshipsImporter', schemas.Unset] = schemas.unset,
        owner: typing.Union['ProjectsGetByProjectIdResponseDataRelationshipsOwner', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
