...
class OrgIacSettingsRequestAttributesCustomRules(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["inherit_from_parent", "is_enabled", "oci_registry_tag", "oci_registry_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["inherit_from_parent", "is_enabled", "oci_registry_tag", "oci_registry_url", ], str]):
