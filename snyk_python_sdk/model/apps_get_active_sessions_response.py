...
class AppsGetActiveSessionsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SessionData']:
                        return SessionData
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SessionData'], typing.List['SessionData']],
                ...
                def __getitem__(self, i: int) -> 'SessionData':
