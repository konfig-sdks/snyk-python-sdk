...
class ProjectsUpdateByProjectIdResponseDataRelationships(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def organization() -> typing.Type['ProjectsUpdateByProjectIdResponseDataRelationshipsOrganization']:
                return ProjectsUpdateByProjectIdResponseDataRelationshipsOrganization
            ...
            @staticmethod
            def importer() -> typing.Type['ProjectsUpdateByProjectIdResponseDataRelationshipsImporter']:
                return ProjectsUpdateByProjectIdResponseDataRelationshipsImporter
        
            @staticmethod
            def owner() -> typing.Type['ProjectsUpdateByProjectIdResponseDataRelationshipsOwner']:
                return ProjectsUpdateByProjectIdResponseDataRelationshipsOwner
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["organization"]) -> 'ProjectsUpdateByProjectIdResponseDataRelationshipsOrganization': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["target"]) -> MetaOapg.properties.target: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["importer"]) -> 'ProjectsUpdateByProjectIdResponseDataRelationshipsImporter': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["owner"]) -> 'ProjectsUpdateByProjectIdResponseDataRelationshipsOwner': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["organization"]) -> 'ProjectsUpdateByProjectIdResponseDataRelationshipsOrganization': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["target"]) -> MetaOapg.properties.target: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["importer"]) -> typing.Union['ProjectsUpdateByProjectIdResponseDataRelationshipsImporter', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["owner"]) -> typing.Union['ProjectsUpdateByProjectIdResponseDataRelationshipsOwner', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        importer: typing.Union['ProjectsUpdateByProjectIdResponseDataRelationshipsImporter', schemas.Unset] = schemas.unset,
        owner: typing.Union['ProjectsUpdateByProjectIdResponseDataRelationshipsOwner', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
