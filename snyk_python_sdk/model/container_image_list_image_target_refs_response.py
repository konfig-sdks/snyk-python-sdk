...
class ContainerImageListImageTargetRefsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ImageTargetRef']:
                        return ImageTargetRef
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ImageTargetRef'], typing.List['ImageTargetRef']],
                ...
                def __getitem__(self, i: int) -> 'ImageTargetRef':
