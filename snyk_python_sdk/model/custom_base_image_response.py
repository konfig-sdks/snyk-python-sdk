...
class CustomBaseImageResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['CustomBaseImageResource']:
                return CustomBaseImageResource
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'CustomBaseImageResource': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'CustomBaseImageResource': ...
