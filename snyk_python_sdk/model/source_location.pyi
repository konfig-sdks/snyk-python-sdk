...
class SourceLocation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["file", "region", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["file", "region", ], str]):
