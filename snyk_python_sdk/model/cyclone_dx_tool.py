...
class CycloneDxTool(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "vendor", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "vendor", ], str]):
