...
class CustomBaseImageCollectionResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['CustomBaseImageCollectionResponseData']:
                return CustomBaseImageCollectionResponseData
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'CustomBaseImageCollectionResponseData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'CustomBaseImageCollectionResponseData': ...
