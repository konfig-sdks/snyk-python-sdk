...
class SettingsAttributes(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["severity_threshold", "target_channel_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["severity_threshold", "target_channel_id", ], str]):
