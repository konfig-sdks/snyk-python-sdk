...
class ServiceAccountsUpdateGroupNameByIdResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ServiceAccountsUpdateGroupNameByIdResponseData']:
                return ServiceAccountsUpdateGroupNameByIdResponseData
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ServiceAccountsUpdateGroupNameByIdResponseData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'ServiceAccountsUpdateGroupNameByIdResponseData': ...
