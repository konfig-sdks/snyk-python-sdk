...
class ServiceAccountsCreateGroupResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ServiceAccountsCreateGroupResponseData']:
                return ServiceAccountsCreateGroupResponseData
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ServiceAccountsCreateGroupResponseData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'ServiceAccountsCreateGroupResponseData': ...
