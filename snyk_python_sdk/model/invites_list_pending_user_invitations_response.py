...
class InvitesListPendingUserInvitationsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OrgInvitation']:
                        return OrgInvitation
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['OrgInvitation'], typing.List['OrgInvitation']],
                ...
                def __getitem__(self, i: int) -> 'OrgInvitation':
