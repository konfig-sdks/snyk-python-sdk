...
class OrgsListAccessibleOrganizationsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OrgWithRelationships']:
                        return OrgWithRelationships
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['OrgWithRelationships'], typing.List['OrgWithRelationships']],
                ...
                def __getitem__(self, i: int) -> 'OrgWithRelationships':
