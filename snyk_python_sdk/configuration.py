...
from snyk_python_sdk.exceptions_base import ApiValueError
from snyk_python_sdk.exceptions import ClientConfigurationError
from snyk_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = snyk_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.snyk.io/rest" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if api_token:
            self.api_key['APIToken'] = api_token
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("snyk_python_sdk")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: REST\n"\
               "SDK Package Version: REST".\
